(function($) {
  ...
  */
  ...
  module('Parchment', {
    ...
    setup: function() {
      this.textarea1 = $('#qunit-fixture1');
      this.textarea2 = $('#qunit-fixture2');
    }
  });
  ...
  test('is chainable', function() {
    ...
    strictEqual(this.textarea1.parchment(), this.textarea1, 'should be chainable');
  });

  // test('multiple instances', function() {
  //   expect(1);
  //   // Not a bad test to run on collection methods.
  //   strictEqual(this.textarea2.parchment(), this.textarea2, 'should be chainable');
  // });
